...
_.onEvent_0_g$ = function dgf_g$(event_0_g$){
  hF_g$(event_0_g$.type);
  this.val$map2_0_g$.forEachFeatureAtPixel(this.val$map2_0_g$.getEventPixel(event_0_g$), kzc_g$(Oif_g$.prototype.call_0_g$, Oif_g$, [this]));
}
;
function Jif_g$(){
  Jif_g$ = Object;
...
//# sourceMappingURL=http://127.0.0.1:9876/sourcemaps/gwtol3playground/1DC56FFEDBCBF943820F31C33CEB22C2_sourcemap.json 
