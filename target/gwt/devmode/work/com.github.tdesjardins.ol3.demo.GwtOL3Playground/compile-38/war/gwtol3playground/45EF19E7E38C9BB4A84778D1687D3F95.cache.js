...
;
var simplePopup_0_g$ = null, styleHash_0_g$;
...
function _if_g$(this$static_0_g$, event_0_g$){
  ...
  if (lxc_g$(feature_0_g$, null)) {
    ...
    if (jxc_g$((Sd_g$() , simplePopup_0_g$))) {
      hF_g$('setup popup');
      Sd_g$() , simplePopup_0_g$ = new P_c_g$(true);
      (Sd_g$() , simplePopup_0_g$).setWidth_1_g$('150px');
      nPb_g$(dkb_g$((Sd_g$() , simplePopup_0_g$).getElement_0_g$()), 'color', 'white');
      nPb_g$(dkb_g$((Sd_g$() , simplePopup_0_g$).getElement_0_g$()), 'font-size', 'small');
      nPb_g$(dkb_g$((Sd_g$() , simplePopup_0_g$).getElement_0_g$()), 'borderColor', 'white');
      nPb_g$(dkb_g$((Sd_g$() , simplePopup_0_g$).getElement_0_g$()), 'borderStyle', 'solid');
      nPb_g$(dkb_g$((Sd_g$() , simplePopup_0_g$).getElement_0_g$()), 'borderWidth', '2px');
      nPb_g$(dkb_g$((Sd_g$() , simplePopup_0_g$).getElement_0_g$()), 'backgroundColor', 'black');
    }
    (Sd_g$() , simplePopup_0_g$).setPopupPosition_0_g$(left_0_g$, top_0_g$);
    msg_0_g$ = new $Fc_g$;
    msg_0_g$.appendHtmlConstant_0_g$(name_0_g$);
    (Sd_g$() , simplePopup_0_g$).setWidget_1_g$(new $6c_g$(msg_0_g$.toSafeHtml_0_g$()));
    (Sd_g$() , simplePopup_0_g$).show_1_g$();
  }
   else {
    if (ixc_g$((Sd_g$() , simplePopup_0_g$)))
      (Sd_g$() , simplePopup_0_g$).hide_0_g$();
  }
}
...
//# sourceMappingURL=http://127.0.0.1:9876/sourcemaps/gwtol3playground/45EF19E7E38C9BB4A84778D1687D3F95_sourcemap.json 
