...
_.createPointerFeature_0_g$ = function Iif_g$(map_0_g$){
  ...
  selectListener_0_g$ = kzc_g$(cgf_g$.prototype.onEvent_0_g$, cgf_g$, [this, selectFeature_0_g$, map_0_g$]);
  p9e_g$(selectFeature_0_g$, 'pointermove', selectListener_0_g$);
...
function cgf_g$(this$0_0_g$, val$selectFeature_0_g$, val$map_0_g$){
  Zff_g$();
  this.this$01_78_g$ = this$0_0_g$;
  this.val$selectFeature2_1_g$ = val$selectFeature_0_g$;
  this.val$map3_0_g$ = val$map_0_g$;
  i_g$.call(this);
  $ff_g$(this);
}
...
_.onEvent_0_g$ = function dgf_g$(event_0_g$){
  var feature_0_g$, featureFunc_0_g$, selectedFeatures_0_g$;
  selectedFeatures_0_g$ = this.val$selectFeature2_1_g$.getFeatures();
  hF_g$(selectedFeatures_0_g$.getLength() + ' ');
  hF_g$(event_0_g$.type);
  featureFunc_0_g$ = kzc_g$(Oif_g$.prototype.call_0_g$, Oif_g$, [this]);
  feature_0_g$ = this.val$map3_0_g$.forEachFeatureAtPixel(this.val$map3_0_g$.getEventPixel(event_0_g$), featureFunc_0_g$);
  if (lxc_g$(feature_0_g$, null)) {
    hF_g$(ozc_g$(feature_0_g$));
  }
}
;
function Jif_g$(){
...
function Zif_g$(this$static_0_g$, feature_0_g$){
  var features_0_g$, name_0_g$;
  name_0_g$ = Nwc_g$(Nwc_g$(feature_0_g$.get('name')));
  hF_g$('call:' + name_0_g$);
  if (lxc_g$(feature_0_g$, null)) {
    hF_g$('call:' + ozc_g$(feature_0_g$));
  }
  features_0_g$ = [feature_0_g$];
  return features_0_g$;
}
...
_.call_0_g$ = function Pif_g$(feature_0_g$){
  return Zif_g$(this, Mwc_g$(feature_0_g$, $wnd.ol.Feature));
}
;
_.call_4_g$ = function $if_g$(feature_0_g$){
  return Zif_g$(this, feature_0_g$);
}
;
function Rif_g$(){
  Rif_g$ = Object;
...
//# sourceMappingURL=http://127.0.0.1:9876/sourcemaps/gwtol3playground/EDD5AF15DDB896894B85BB53D49898B6_sourcemap.json 
