...
_.onEvent_0_g$ = function dgf_g$(event_0_g$){
  var feature_0_g$, featureFunc_0_g$, p_0_g$;
  hF_g$(ozc_g$(event_0_g$));
  p_0_g$ = this.val$map2_0_g$.getEventPixel(event_0_g$);
  hF_g$(Waf_g$(p_0_g$) + ' ' + Xaf_g$(p_0_g$));
  featureFunc_0_g$ = kzc_g$(Oif_g$.prototype.call_0_g$, Oif_g$, [this]);
  feature_0_g$ = this.val$map2_0_g$.forEachFeatureAtPixel(this.val$map2_0_g$.getEventPixel(event_0_g$), featureFunc_0_g$);
...
//# sourceMappingURL=http://127.0.0.1:9876/sourcemaps/gwtol3playground/CB114C35CBABB50BABB8432C602C7B11_sourcemap.json 
