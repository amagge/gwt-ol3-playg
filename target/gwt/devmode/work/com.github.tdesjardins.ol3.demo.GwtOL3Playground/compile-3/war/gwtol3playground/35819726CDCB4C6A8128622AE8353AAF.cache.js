...
_.show_0_g$ = function Vd_g$(exampleId_0_g$){
  var centerCoordinate_0_g$, kmlFormat_0_g$, kmlOptions_0_g$, kmlSource_0_g$, lstLayer_0_g$, map_0_g$, mapOptions_0_g$, osmSource_0_g$, rasterLayer_0_g$, rasterLayerOptions_0_g$, selectFeature_0_g$, selectListener_0_g$, stamenOptions_0_g$, style_0_g$, vectorKMLSourceOptions_0_g$, vectorLayer_0_g$, vectorLayerOptions_0_g$, view_0_g$;
  kmlOptions_0_g$ = Owc_g$(C7e_g$());
  kmlOptions_0_g$.extractStyles = false;
  kmlFormat_0_g$ = new $wnd.ol.format.KML(kmlOptions_0_g$);
  vectorKMLSourceOptions_0_g$ = Owc_g$(C7e_g$());
  ...
  selectListener_0_g$ = kzc_g$(cgf_g$.prototype.onEvent_0_g$, cgf_g$, [this, selectFeature_0_g$]);
...
function bgf_g$(this$static_0_g$, event_0_g$){
  var feature_0_g$, output_0_g$, selectedFeatures_0_g$;
  selectedFeatures_0_g$ = this$static_0_g$.val$selectFeature2_1_g$.getFeatures();
...
function cgf_g$(this$0_0_g$, val$selectFeature_0_g$){
  Zff_g$();
...
_.onEvent_0_g$ = function dgf_g$(event_0_g$){
  bgf_g$(this, Owc_g$(event_0_g$));
}
;
_.onEvent_1_g$ = function egf_g$(event_0_g$){
  bgf_g$(this, event_0_g$);
}
;
function ce_g$(){
  ce_g$ = Object;
...
//# sourceMappingURL=http://127.0.0.1:9876/sourcemaps/gwtol3playground/35819726CDCB4C6A8128622AE8353AAF_sourcemap.json 
