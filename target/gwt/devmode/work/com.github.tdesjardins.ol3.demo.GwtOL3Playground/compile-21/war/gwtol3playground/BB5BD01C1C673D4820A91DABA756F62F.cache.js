...
_.onEvent_0_g$ = function dgf_g$(event_0_g$){
  var feature_0_g$, p_0_g$;
  hF_g$(ozc_g$(event_0_g$));
  p_0_g$ = this.val$map2_0_g$.getEventPixel(event_0_g$);
  hF_g$(Waf_g$(p_0_g$) + ' ' + Xaf_g$(p_0_g$));
  feature_0_g$ = this.val$map2_0_g$.forEachFeatureAtPixel(this.val$map2_0_g$.getEventPixel(event_0_g$), kzc_g$(Oif_g$.prototype.call_0_g$, Oif_g$, [this]));
...
//# sourceMappingURL=http://127.0.0.1:9876/sourcemaps/gwtol3playground/BB5BD01C1C673D4820A91DABA756F62F_sourcemap.json 
